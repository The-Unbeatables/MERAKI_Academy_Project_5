...
import "./style.css";
import { FcMoneyTransfer, FcSupport, FcBullish, FcPaid, FcShipped, FcOk, FcPlus } from "react-icons/fc";
    ...
    <>
      <div className="biggestss">
        ...
        <div className="stat-container">
          ...
          <div className="stats">
            ...
            <div className="right_adm">
              ...
              <FcMoneyTransfer style={{paddingTop: '15px'}} />
            </div>
          </div>
          <div className="stats">
            <div className="left_adm">
            ...
            <div className="right_adm">
              ...
              <FaUserSecret style={{paddingTop: '15px', color: 'green'}}/>
            </div>
          </div>
          <div className="stats">
            <div className="left_adm">
            ...
            <div className="right_adm">
              ...
              <FcPlus style={{paddingTop: '15px', color: 'green'}}/>
            </div>
          </div>
          <div className="stats">
            <div className="left_adm">
            ...
            <div className="right_adm">
              ...
              <FcBullish style={{paddingTop: '15px', color: 'green'}}/>
            </div>
          </div>
          <div className="stats">
            <div className="left_adm">
            ...
            <div className="right_adm">
              ...
              <FcPaid style={{paddingTop: '15px', color: 'green'}}/>
            </div>
          </div>
          <div className="stats">
            <div className="left_adm">
            ...
            <div className="right_adm">
              ...
              <FcShipped style={{paddingTop: '15px', color: 'green'}}/>
            </div>
          </div>
          <div className="stats">
            <div className="left_adm">
            ...
            <div className="right_adm">
              ...
              <FcOk style={{paddingTop: '15px', color: 'green'}}/>
            </div>
          </div>
        </div>
        <div className="recent">
          ...
          <div className="container_table_detailes">
            ...
            {users.slice(0, 5).map((elem, i) => {
              return (
                <div className="roshan" key={i}>
                  ...
                  <div className="huskar">
                    <h4 className="table_text">{elem.email}</h4>
                  </div>

                  <div className="huskar">
                    {elem.role_id === 1 && <h4 className="table_text">Admin</h4>}
                    {elem.role_id === 2 && <h4 className="table_text">Customer</h4>}
                    {elem.role_id === 3 && <h4 className="table_text">Worker</h4>}
                  </div>

                  <div className="huskar">
                    <h4 className="table_text">{elem.created_at.split("T")[0]}</h4>
                  </div>
                </div>
              );
            })}
